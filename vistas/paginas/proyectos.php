...
<head>
	<meta charset="utf-8">
	<title>MekaDesign - Proyectos</title>
					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-xl-4 col-lg-4 col-md-4">
								...
								<p class="parrafosInfoProyecto">Inamiki, es un sitio web de búsqueda de negocios o empresas locales, el cliente solicitaba la creación del FRONT-END del sitio, a partir de un diseño web ya hecho.</p>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4">
								<h6 class="h6Titulo mb-3">SOLUCIÓN</h6>
								<p class="parrafosInfoProyecto">El diseño web del sitio fue entregado a nuestro equipo de desarrolladores, a partir de ello, platicamos sobre las posibles tecnologías a usar para el desarrollo del sitio. Se determinaron los puntos clave del sitio web para poner énfasis en determinados puntos.</p>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4">
								<h6 class="h6Titulo mb-3">RESULTADO</h6>
								<p class="parrafosInfoProyecto">Como resultado, obtuvimos la creación de un sitio web totalmente funcional desde la parte del FRONT-END, introduciendo efecto en la página que sean vistosos a la vista de los usuarios.</p>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="col-xl-6 col-lg-6 col-md-6 mb-5">
								<div class="row">
									...
									<div class="col-xl-6 col-lg-6 col-md-6">
										...
										<p class="parrafosInfoProyecto">Desarrollo Móvil</p>
