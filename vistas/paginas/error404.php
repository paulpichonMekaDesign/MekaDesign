...
<body>
	...
	<div class="error404">
		<div class="container">
			<h1 class="mensaje404">Error 404</h1>
			<h1 class="noEncontradoH1">Al parecer la página solicitada no esta disponible o no existe.</h1>
			<p class="texto404">Por favor abre el menú y navega en alguna de las opciones dadas.</p>
		</div>
	</div>
