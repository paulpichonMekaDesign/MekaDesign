     ...
     <div class="container-fluid">
          <header class="menu d-flex justify-content-between">
               <div class="logoMekaDesign">
                    <a href="http://localhost/MekaDesign/"><img class="imgLogoMenu" src="vistas/imagenes/menu/logo-MekaDesing.png" alt="MekaDesign Logo"></a>
               </div>
     ...
     <section class="bodyContenedor">
          <nav class="menuDesplegado">
               <div class="menu__item">
                    <a href="http://localhost/MekaDesign/" class="menu__item-link">Inicio</a>
               ...
               <div class="container-fluid">
                    <div class="row d-flex justify-content-end">
                         <div class="col-xl-2 col-lg-2 text-center">
                              <a href="http://localhost/MekaDesign/"><img class="imgFooterMenu" src="vistas/imagenes/menu/logo-MekaDesing.png" alt="Imagen MekaDesign Logo"></a>
                         </div>
